...
if ($_FILES['photo1']['tmp_name'] != '')
...

		{
			...
			$targetPhoto = "../uploads/gallery_img_".$pageID.".jpg";


			$thumbPhoto = "../uploads/gallery_img_thumb".$pageID.".jpg";
			...
			corp_img($targetPhoto,$thumbPhoto,400,300, $_FILES['photo1']['name']);
                                        ...
                                        <div class="modal-body">
											 ...
											 <div class="row"><div class="col-xs-12 col-md-12">
				                                	...
				                                	<div class="form-group">
                                           			 ...
                                           			 <label>Cover Photo <small>(400 x 300)</small></label>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            ...
            <small>Manage photo galleries, after you create the gallery you can upload photos to that gallery.</small>
        ...
        <div class="row">
                ...
                <div class="col-lg-12">
                  ...
                  <?
						        ...
						        $data = getAllData('exceed_gallery_cats', 'type="gallery" order by `order`');
						        ...
						        $delCond = 'delete from `exceed_gallery_cats` where id='.$data[$j][0];
						       	...
						       	$oimgPhoto = "../uploads/gallery_img_".$data[$j][0].".jpg";


								$imgPhoto = "../uploads/gallery_img_thumb".$data[$j][0].".jpg";
						        ...
						        <div class="pull-right">
						            ...
						            <a href="_app_gallery_photos.php?id=<?=$data[$j][0];?>" class="btn btn-sm btn-primary"><i class="fa fa-photo fa-fw"></i> Manage Photos</a>


						        	<a href="javascript:;" onclick="return cropImg('cropImg','<?=$oimgPhoto?>','<?=$imgPhoto?>', '0|0|100|100','400x300');" data-toggle="modal" data-target="#cropImg" class="btn btn-sm btn-success"><i class="fa fa-crop fa-fw"></i> Crop Cover</a>
