...
$_ACTIVE['home'] = $_ACTIVE['home_testimonials'] = 'active';
                     ...
                     <div class="col-xs-12 col-md-6 col-lg-6">
                      ...
                      <div class="col-xs-12 col-md-6 col-lg-2">
                        ...
                        <div class="form-group">
                        	...
                        	?>
                      		<label>Display Testimonial</label> <br>
                            <input type="radio" name="home-paragraph-all-<?=$settingsSuffix?>" <?=$homeParaStatus1[1];?> value="1"  />&nbsp;&nbsp;Random One  &nbsp;&nbsp;
                            <input type="radio" name="home-paragraph-all-<?=$settingsSuffix?>" <?=$homeParaStatus1[0];?> value="0"  />&nbsp;&nbsp;Latest One <br /><br />
                        </div> 
                       </div>
