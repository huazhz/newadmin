...
?>
      ...
      <section class="content">
      	...
      	$widgetTitle = 'Banner';
                $widgetID = 10001;
                $widgetParentURL = '_home_whywearedifferent.php';
                include "_home_inc_section_widgets.php";
      	?>
         <div class="row">
                <div class="col-lg-12">
                ...
                <div class="box-body">
                  <div class="row">
                     ...
                     <div class="col-xs-12 ">
                     	...
                     	<textarea name="home-paragraph-contents-<?=$settingsSuffix?>" id="home-paragraph-contents-<?=$settingsSuffix?>"><?=unFormatData($_SETTINGS['home-paragraph-contents-'.$settingsSuffix])?></textarea>
	                     	<br>
                         </div>
                         ...
                         <div class="col-xs-12 col-md-3">
				                                	<div class="form-group">
                                            			...
                                            			<input name="home-paragraph-readmore-title-<?=$settingsSuffix?>" value="<?=unFormatData($_SETTINGS['home-paragraph-readmore-title-'.$settingsSuffix])?>" class="form-control">
				                                ...
				                                <div class="col-xs-12 col-md-9">
				                                	<div class="form-group">
                                           			 <label>URL</label>
                                           			  <input name="home-paragraph-readmore-url-<?=$settingsSuffix?>" value="<?=unFormatData($_SETTINGS['home-paragraph-readmore-url-'.$settingsSuffix])?>" id="linkURL" class="page-selector form-control">
                                        			</div>
				                                </div>
