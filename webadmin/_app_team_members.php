...
$_ACTIVE['app'] = $_ACTIVE['app_team_members'] = 'active';
	...
	?>
											 ...
											 <div class="row">
				                                ...
				                                <div class="col-xs-12 col-md-6">
				                                 ...
				                                 <div class="col-xs-12 col-md-6">
				                                	<div class="form-group">
                                           			 <label>Email </label>
                                            			<input name="seo_keywords" class="form-control">
      ...
      <div class="content-wrapper">
        <section class="content-header">
               	<a href="javascript:;"  style="float:right;" onclick="return addForm('adminsform', 'Add New Team Member');" data-toggle="modal" data-target="#adminsform"  class="btn btn-success"><i class="fa fa-plus fa-x1"></i> Add New Team Member</a>
          <h1>
           Team Members
            <small>Manage all team members!</small>
          </h1>
        </section>
               ...
               <div class="row">
                <div class="col-lg-12">
                  ...
                  <?
						        ...
						        $data = getAllData('exceed_pages', 'navigation=10005 order by `order`');
						        if (sizeof($data) > 0)
						        {
						        ?>
								...
								<div class="sortable-heading"><strong><i class="fa fa-arrows-v"></i><img src="<?=$imgPhoto?>" style="float:left;margin-right:10px;height:100px;"> <?=unFormatData($data[$j][1])?> | <?=unFormatData($data[$j][9])?> </strong><br>
