...
$_ACTIVE['home'] = $_ACTIVE['home_products'] = 'active';
...
if (sizeof($_POST) > 0)
{
		...
		$addObj['sidenavpages'] = formatData($_POST['sidenavpages']);
		$addObj['pageapps'] = formatData($_POST['pageapps']);
		...
		if ($_FILES['photo1']['tmp_name'] != '')
		{
			...
			{
				corp_img($targetPhoto,$thumbPhoto,500,320, $_FILES['photo1']['name']);
			}
			else
			{
	...
	?>
											 ...
											 <div class="row">
											  <div class="col-md-6">
				                                	<div class="form-group">
                                           			 <label>Photo <small>(500 x 320)</small></label>
				                                ...
				                                <div class="col-xs-12 col-md-4">
				                                	<div class="form-group">
                                           			 ...
                                           			 <input name="sidehtmlcontents" class="form-control">
                                        			</div>
				                                </div>
				                                <div class="col-xs-12 col-md-5">
				                                	<div class="form-group">
                                           			 <label>Button (2) URL</label>
                                            			<input type="text" id="sidenavpages"  class="form-control page-selector" name="sidenavpages">
                                        			</div>
				                                </div>
				                                <div class="col-xs-12 col-md-3">
				                                	<div class="form-group">
                                           			 <label>Button (2) Target</label>
                                            			 <select name="pageapps" class="form-control">
                                           			 <option value="_self">Same Window</option>
                                           			 <option  value="_blank">New Window</option>
                                           			 </select>
                                        			</div>
      ...
      <div class="content-wrapper">
        <section class="content-header">
               	<a href="javascript:;"  style="float:right;" onclick="return addForm('adminsform', 'Add New Product');" data-toggle="modal" data-target="#adminsform"  class="btn btn-success"><i class="fa fa-plus fa-x1"></i> Add New Product</a>
          <h1>
          Featured Home Products
            <small>Manage Home Featured Products !</small>
          </h1>
        </section>
               ...
               <div class="row">
                <div class="col-lg-12">
                  ...
                  <?
						        ...
						        <a href="_copy_record.php?data=<?=encodeRequest('_home_products.php|exceed_pages|'.$data[$j][0])?>" onclick="return confirm('are you sure to duplicate this message?');"class="btn btn-sm   btn-primary"><i class="fa fa-copy fa-fw"></i> Duplicate</a>
						        	
						        	<?
						        	if ($data[$j]['pagestyle'] <= 0)
						        	{
						        	?>
						        	<a href="javascript:;" onclick="return cropImg('cropImg','<?=$oimgPhoto?>','<?=$imgPhoto?>', '0|0|100|80','500x320');" data-toggle="modal" data-target="#cropImg" class="btn btn-sm btn-success"><i class="fa fa-crop fa-fw"></i> Crop Image</a>
						        	<?
						        	}
						        	?>
